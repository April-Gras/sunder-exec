<template>
  <div>
    ...
    <div class="tw-grid tw-grid-cols-1 tw-gap-4 md:tw-grid-cols-2 lg:tw-grid-gap-6">
      <FileReading v-for="config in fileConfigs" :key="config.directoryPath" :config="config" />
    </div>
  </div>
</template>
